...
During my honours research, I worked with primary data to analyze how households respond to price fluctuations of fruits and vergetables. Using Stata(tobit regression model), I applied statistical techniques to extract insights on consumer behavior and economic resilience.
